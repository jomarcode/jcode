        ...
        @include('clientes.modal-delete')
            <div class="card mb-3" style="max-width: 540px;">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <h3 class="card-title">{{$cliente->name}}</h3><br><hr>
                    ...
                    <a href="{{URL::route('clientes.edit',$cliente->id)}}">
                        <button type="button" class="btn btn-info btn-sm ">
                            <i class="far fa-edit"></i>
                        </button>
                    </a>
                    <button type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#modalEliminar-{{$cliente->id}}">
